...
namespace ApiCourseIsolated.Common
{
    public class SpanishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateEmail(string email) { return new IdentityError { Code = nameof(DuplicateEmail), Description = $"La direccion de email '{email}' ya se encuentra registrada. Puede recuperar su contraseña para ingresar nuevamente al sistema." }; }
